        ...
        <div className="form-wrapper">
            <header className="create-post-header">
                ...
                <p className="create-post-description">
                    Share as much detail as possible to help neighbors identify your pet. Mention unique markings,
                    the color of their collar, their temperament (are they shy or friendly?), and exactly where
